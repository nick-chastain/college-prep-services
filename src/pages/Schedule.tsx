          ...
          <div className="container px-6 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
              {steps.map((step, index) => (
                ...
                >
                  <div className="rounded-full w-14 h-14 bg-accent flex items-center justify-center mb-4 mx-auto text-brand-teal">
                    {step.icon}
                  </div>
                  <h3 className="text-lg font-medium mb-2">{step.title}</h3>
                  <p className="text-brand-dark/70 text-sm">{step.description}</p>
                </motion.div>
              ))}
            </div>
            ...
            <div className="mt-16 bg-white rounded-xl p-8 border border-gray-100 shadow-sm max-w-2xl mx-auto">
